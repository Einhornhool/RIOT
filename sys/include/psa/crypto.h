 ...
 *
 *          The application must call this function before calling @ref psa_aead_set_nonce()
 ...
 *
 *          This function generates a random nonce for the authenticated encryption operation
 ...
 *
 *          This function sets the IV, nonce or initial counter value for the encryption or
 ...
 * @brief   Destroy a key.
 *
 *          This function destroys a key from both volatile memory and, if applicable, non-volatile
 ...
 *
 *          The output of this function can be passed to @ref psa_import_key() to create an
 *          equivalent object.
 *
 ...
 *
 *          The output of this function can be passed to @ref psa_import_key() to create an object
 ...
 *              public key @verbatim y = g^x mod p @endverbatim as a big-endian byte string. The
 ...
 *
 *          This function generates a random symmetric key. As of yet it does not implement
 ...
 *
 *          This function is being used to generate a random number if no other driver for random
 ...
 *
 *          The application must choose a value for id between @ref PSA_KEY_ID_USER_MIN and
 ...
 *
 *          To make a key persistent, give it a persistent key identifier by using
 ...
 *
 *          This function overwrites any key type previously set in @c attributes.
 *
 * @param   attributes  The attribute object to write to.
 ...
 *
 *          This function first resets the attribute object as with @ref psa_reset_key_attributes().
 ...
 *
 *          Aborting an operation frees all associated resources except for the  @p operation
 ...
 *
 *          This function copies the state of an ongoing hash operation to a new operation object.
 ...
 *
 *          The application must call @ref psa_hash_setup() before calling this function.
 ...
 *
 *          See @ref psa_hash_suspend() for an example of how to use this function to suspend
 ...
 *
 *          The application must call @ref psa_hash_setup() or @ref psa_hash_resume() before
 ...
 *
 *          The application must call @ref psa_hash_setup() before calling this function. This
 ...
 *
 *          When this function returns successfuly, the operation becomes inactive. If this
 *          function returns an error status, the operation enters an error state and must be
 *          aborted by calling @ref psa_hash_abort().
 *
 ...
 *
 *          This function supports any output from @ref psa_export_key(). Refer to the
